...
python3 "$OMIM_PATH/tools/python/stylesheet/dump_priorities.py" \
  "$DATA_PATH/drules_proto_clear.bin" > "$DATA_PATH/prios.drules_proto_clear.txt"

python3 "$OMIM_PATH/tools/python/stylesheet/dump_priorities.py" \
  "$DATA_PATH/drules_proto_vehicle_clear.bin" > "$DATA_PATH/prios.drules_proto_vehicle_clear.txt"
